...
<div id="Cont-Mis-Canchas">
    ...
    <div id="Cont-Infor">
        ...
        <div id="cont-">
            ...
            <textarea name="" type="text"  id="description" class="input_"/></textarea>
        </div>

        <input name="" type="button" class="Send_" id="create" value="Crear"/>
    ...
    <div>
        ...
        <table>
            ...
            {foreach from=$fields item=complex}
                <tr>
                    <td>
                        <a href="{$_params.site}/administrador-canchas/index/editarcancha/{$complex->codcomplex}">{$complex->name}</a>
                    </td>
                    <td>
                        <a href="{$_params.site}/administrador-canchas/index/subs/{$complex->codcomplex}">Canchas</a>
                    </td>
                </tr>
            {/foreach}
        </table>
