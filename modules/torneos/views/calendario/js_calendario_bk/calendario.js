...
//         $(".all-match").click(function() {
//             $("#" + _this.id_popup_detalle + " #contend-actions-adicionales").html("");
//             $("#" + _this.id_popup_detalle + " #contend-detalle").html("");

//             $('#' + _this.id_popup_detalle).modal('show');

//             var aux_element = $(this);
//             var aux_obj = new obj();

//             aux_obj.titulo = aux_element.attr("title");
//             aux_obj.partido.cod = aux_element.attr("codmatch");
//             aux_obj.partido.num = aux_element.attr("num");
//             aux_obj.partido.irpartido = aux_element.attr("irpartido");
//             aux_obj.partido.date = aux_element.attr("date");
//             aux_obj.partido.hour = aux_element.attr("hour");
//             aux_obj.partido.grupo = aux_element.attr("round");
//             aux_obj.partido.jornada = aux_element.attr("numjornada");
//             aux_obj.partido.titulo = aux_element.attr("local") + " VS " + aux_element.attr("visitant");
//             aux_obj.partido.local.cod = aux_element.attr("teamlocal");
//             aux_obj.partido.local.name = aux_element.attr("local");
//             aux_obj.partido.local.score = aux_element.attr("scorelocal");
//             aux_obj.partido.local.ir = aux_element.attr("irlocal");
//             aux_obj.partido.local.img = aux_element.attr("imglocal");
//             aux_obj.partido.visitant.cod = aux_element.attr("teamvisitant");
//             aux_obj.partido.visitant.name = aux_element.attr("visitant");
//             aux_obj.partido.visitant.score = aux_element.attr("scorevisitant");
//             aux_obj.partido.visitant.ir = aux_element.attr("irvisitant");
//             aux_obj.partido.visitant.img = aux_element.attr("imgvisitant");
//             aux_obj.partido.lugar.codcomplex = aux_element.attr("codcomplex");
//             aux_obj.partido.lugar.ircomplex = aux_element.attr("ircomplex");
//             aux_obj.partido.lugar.namecomplex = aux_element.attr("namecomplex");
//             aux_obj.partido.lugar.descriptionplace = aux_element.attr("descriptionplace");

//             _this.loadContendDetalle(aux_obj);
//         });
//     };
...
//         if (!validate.isEmpty(aux_obj.partido.irpartido)) {
//             $("#" + _this.id_popup_detalle + " #contend-actions-adicionales").html(
//                     '<a href="' + aux_obj.partido.irpartido + '" target="_blank" style="text-decoration: none;">\n\
//                     <button class="btn btn-default btn_blue_light" title="Ir al Partido" style="margin-right: 3px;">Ir al Partido</button>\n\
//                 </a>');
//         }
