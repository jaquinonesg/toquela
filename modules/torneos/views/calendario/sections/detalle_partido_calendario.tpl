                ...
                <div class="panel panel-info">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            {foreach from=$team_local->players item=player key=index}
                            <a href="{$_params.site}/perfil?cod={$player->coduser}" target="blank">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 player">    
                                <p><span class="icon-user"></span>{$player->name} {$player->lastname}</p>
                                </div>
                            </a>
                            {/foreach}
                        </div>
            ...
            <div class="panel-group" id="accordion-visitant" role="tablist" aria-multiselectable="true">
                <div class="panel panel-info">
                    ...
                    <div id="visitant" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            {foreach from=$team_visitant->players item=player key=index}
                            <a href="{$_params.site}/perfil?cod={$player->coduser}" target="blank">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 player">    
                                    <p><span class="icon-user"></span>{$player->name} {$player->lastname}</p>
                                </div>
