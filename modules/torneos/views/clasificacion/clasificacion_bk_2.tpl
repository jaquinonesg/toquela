        ...
        <div class="row">
            ...
            {else}
                    ...
                    <table class="table">
                        ...
                        {foreach from=$teams item=team key=i}
                            <tr>
                                ...
                                <td><span class="glyphicon glyphicon-hand-right"></span> &nbsp;{$team->name}</td>
                                <td>{$team->J}</td>
                                <td>{$team->G}</td>
                                <td>{$team->E}</td>
                                <td>{$team->P}</td>
                ...
                {include file=$_params.root|cat:"views/_templates/info_calendario.tpl"}
                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 4%;">
                <button class="btn btn-primary btn_mas_resultados"torneo="{$tournament->codtournament}" fase="{$fase->number}" tipo="{$fase->type}" style="float: right; margin-bottom: 2%;">Mas resultados</button>
                </div>
                {include file=$_params.root|cat:"views/_templates/maqueta_calendar_fases_resultado.tpl"}
            {/if}
        {/if}
        </div>
        <div class="clear"></br></div>
