...
<div id="Cont-Mis-Canchas">
    ...
    <div id="Cont-Infor">
        ...
        <div id="cont-">
            ...
            <input type="text"  id="name" class="input_"/>
        </div>

        <input type="button" class="Send_" id="create" value="Crear" data-code="{$codecomplex}"/>
        ...
        {if isset($subs) && count($subs) > 0}     
            <table>
                ...
                {foreach from=$subs item=sub}
                    <tr>
                        <td>
                            <a href="{$_params.site}/administrador-canchas/index/editarsub/{$sub->codsubcomplex}">{$sub->name}</a>
                        </td>
                        <td>
                            <button class="delete_sub" data-code="{$sub->codsubcomplex}">Eliminar</button>
                        </td>
                    </tr>
                {/foreach}
            </table>
