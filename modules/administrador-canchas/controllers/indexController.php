...
//        $this->_complejo = $this->user->codcomplex;
    ...
    public function index() {
        ...
        if ($this->_sesion->user->codrole == 3) {
            ...
            $privilegio = $this->validatePermissionsAdmin($idRoleUser, $idUsuario, 3);
        }
        ...
        if ($privilegio == 3) {
            ...
            $pasa = $this->validarRolesPrivilegios($cod_role, $privilegio, "Para acceder a esta seccion necesita tener permisos para administrar canchas.", null);
        }
