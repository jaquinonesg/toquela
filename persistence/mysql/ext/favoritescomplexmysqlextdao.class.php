 ...
 */
class FavoritesComplexMySqlExtDAO extends FavoritesComplexMySqlDAO {
    ...
    public function getComplexbyUser($cod_user) {
        $sql = "SELECT c.* ,
                   ...
                   (SELECT a.path FROM db_toquela.attachment a , db_toquela.complex_has_attachment cha WHERE cha.cod_attachment = a.cod_attachment AND cha.cod_complex = c.cod_complex LIMIT 1 ) AS 'image'
                FROM 
