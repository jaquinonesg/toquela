 ...
 */
class UserHasAttachmentMySqlDAO extends ModelDAO implements UserHasAttachmentDAO{
...
$this->set($userhasattachment->variable);
        ...
        $sql = "UPDATE db_toquela.user_has_attachment  SET 
		 type = if( strcmp('$userhasattachment->type'  , '' ) = 1  , '$userhasattachment->type', type ),
		 variable = if( strcmp('$userhasattachment->variable'  , '' ) = 1  , '$userhasattachment->variable', variable ) WHERE  cod_attachment =  '$userhasattachment->codattachment' AND  cod_user =  '$userhasattachment->coduser'";
        return $this->executeUpdate($sql);
    }
