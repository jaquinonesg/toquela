 ...
 */
class ComplexHasQualificationMySqlDAO extends ModelDAO implements ComplexHasQualificationDAO{
...
$this->set($coduser);
    ...
    public function update($complexhasqualification){
        ...
        $sql = "UPDATE db_toquela.complex_has_qualification  SET 
		 qualification = if( strcmp('$complexhasqualification->qualification'  , '' ) = 1  , '$complexhasqualification->qualification', qualification ) WHERE  cod_qualification =  '$complexhasqualification->codqualification' AND  cod_complex =  '$complexhasqualification->codcomplex' AND  cod_user =  '$complexhasqualification->coduser'";
        return $this->executeUpdate($sql);
    }
