 ...
 */
class QualificationMySqlDAO extends ModelDAO implements QualificationDAO{
...
$this->set($qualification->type);
        ...
        $sql = "UPDATE db_toquela.qualification  SET 
		 name = if( strcmp('$qualification->name'  , '' ) = 1  , '$qualification->name', name ),
		 description = if( strcmp('$qualification->description'  , '' ) = 1  , '$qualification->description', description ),
		 type = if( strcmp('$qualification->type'  , '' ) = 1  , '$qualification->type', type ) WHERE  cod_qualification =  '$qualification->codqualification'";
        return $this->executeUpdate($sql);
    }
