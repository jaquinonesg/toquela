 ...
 */
class RatingMySqlDAO extends ModelDAO implements RatingDAO{
...
$this->set($codmatch);
    ...
    public function update($rating){
        ...
        $sql = "UPDATE db_toquela.rating  SET 
		 score = if( strcmp('$rating->score'  , '' ) = 1  , '$rating->score', score ) WHERE  cod_user =  '$rating->coduser' AND  cod_match =  '$rating->codmatch'";
        return $this->executeUpdate($sql);
    }
