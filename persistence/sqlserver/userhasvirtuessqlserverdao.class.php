 ...
 * @date: 2013-08-21 17:40
 */
class UserHasVirtuesSqlServerDAO extends ModelDAO implements UserHasVirtuesDAO{
...
$this->set($codvirtues);
    ...
    public function update($userhasvirtues){
        ...
        $sql = "UPDATE db_toquela.user_has_virtues  SET 
		 main = iif( len('$userhasvirtues->main' ) <> 0  , '$userhasvirtues->main', main ) WHERE  cod_user =  '$userhasvirtues->coduser' AND  cod_virtues =  '$userhasvirtues->codvirtues'";
        return $this->executeUpdate($sql);
    }
