 ...
 */
class ExperienceSqlServerDAO extends ModelDAO implements ExperienceDAO{
...
$this->set($codexperience);
    ...
    public function update($experience){
        ...
        $sql = "UPDATE db_toquela.experience  SET 
		 name = iif( len('$experience->name' ) <> 0  , '$experience->name', name ) WHERE  cod_experience =  '$experience->codexperience'";
        return $this->executeUpdate($sql);
    }
