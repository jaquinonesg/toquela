 ...
 */
class PositionSqlServerDAO extends ModelDAO implements PositionDAO{
...
$this->set($codposition);
    ...
    public function update($position){
        ...
        $sql = "UPDATE db_toquela.position  SET 
		 name = iif( len('$position->name' ) <> 0  , '$position->name', name ) WHERE  cod_position =  '$position->codposition'";
        return $this->executeUpdate($sql);
    }
