 ...
 */
class TeamHasVirtuesSqlServerExtDAO extends TeamHasVirtuesSqlServerDAO {
    ...
    public function getFootballType($cod_team) {
        $sql = "SELECT TOP 1 * FROM db_toquela.virtues v, db_toquela.team_has_virtues uht WHERE v.cod_virtues = uht.cod_virtues AND uht.cod_team = '$cod_team' AND v.cod_virtues_group = 6;";
