 ...
 */
class UserHasExperienceSqlServerDAO extends ModelDAO implements UserHasExperienceDAO{
...
$this->set($codexperience);
    ...
    public function update($userhasexperience){
        ...
        $sql = "UPDATE db_toquela.user_has_experience  SET 
		 value = iif( len('$userhasexperience->value' ) <> 0  , '$userhasexperience->value', value ) WHERE  cod_user =  '$userhasexperience->coduser' AND  cod_experience =  '$userhasexperience->codexperience'";
        return $this->executeUpdate($sql);
    }
