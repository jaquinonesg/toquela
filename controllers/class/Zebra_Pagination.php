 ...
 *  @version    2.1 (last revision: February 06, 2013)
...
class Zebra_Pagination
{
    ...
    private $_properties = array(
        ...
        // [Added, He Shiming] the class name for prev/next buttons
        'navigation_class_name'     =>  'navigation',

        // [Added, He Shiming] the class name for number buttons
        'number_class_name'         =>  ''
     ...
     *  [Added, He Shiming]
     *
     *  Change the navigation button class names.
     *
     *  <code>
     *  // change the default navigation button class names
     *  $pagination->class_names('navigation', '');
     *  </code>
     *
     *  @param  string  $navigation (Optional) The class name for navigation buttons.
     *
     *                              Default is "navigation".
     *
     *  @param  string  $number     (Optional) The class name for number buttons.
     *
     *                              Default is "".
     *  @return void
     *
     *  @since  2.2
     */
    public function class_names($navigation = 'navigation', $number = '')
    {

        // set the class name
        $this->_properties['navigation_class_name'] = $navigation;
        $this->_properties['number_class_name'] = $number;
     ...
     *  @return void
     */
    public function render($return_output = false, $class_name = 'Zebra_Pagination')
    {
        ...
        $output = '<div class="'.$class_name.'"><ul>';
    ...
    private function _show_next()
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li><a href="' .
                ...
                // [Changed, He Shiming] using custom navigation class
                '" class="' . $this->_properties['navigation_class_name'] . ' ' . ($this->_properties['reverse'] ? 'previous' : 'next') . ($this->_properties['page'] == $this->_properties['total_pages'] ? ' disabled' : '') . '"' .
    ...
    private function _show_pages()
    {
        ...
        if ($this->_properties['total_pages'] <= $this->_properties['selectable_pages']) {
            ...
            for (
                ...
                // [Changed, He Shiming] make use of number classes
                $output .= '<li><a href="' . $this->_build_uri($i) . '" class="' .

                    $this->_properties['number_class_name'] .

                    // make sure to highlight the currently selected page
                    ($this->_properties['page'] == $i ? ' current' : '') . '">' .
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            // [Changed, He Shiming] make use of number classes
            $output .= '<li><a href="' . $this->_build_uri($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) . '" class="' .

                $this->_properties['number_class_name'] .

                // highlight if the page is currently selected
                ($this->_properties['page'] == ($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) ? ' current' : '') . '">' .
            ...
            // [Changed, He Shiming] make use of number classes
            $output .= '<li><a href="' . $this->_build_uri($this->_properties['reverse'] ? 1 : $this->_properties['total_pages']) . '" class="' .
    ...
    private function _show_previous()
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li><a href="' .
                ...
                // also different class if links are in reverse order
                // [Changed, He Shiming] using custom navigation classes
                '" class="' . $this->_properties['navigation_class_name'] . ' ' . ($this->_properties['reverse'] ? 'next' : 'previous') . ($this->_properties['page'] == 1 ? ' disabled' : '') . '"' .
