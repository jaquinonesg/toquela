<?php /* Smarty version Smarty-3.1.8, created on 2015-05-22 17:51:19
         compiled from "C:\xampp\htdocs\toquela\modules\torneos\views\partido\partido.tpl" */ ?>
<?php /*%%SmartyHeaderCode:322915554b49a888f92-87323277%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cdb18f0c52a195ecd8dc4016ee85eab7719ce522' => 
    array (
      0 => 'C:\\xampp\\htdocs\\toquela\\modules\\torneos\\views\\partido\\partido.tpl',
      1 => 1432335075,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '322915554b49a888f92-87323277',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5554b49ab1dfb5_38334863',
  'variables' => 
  array (
    '_params' => 0,
    'match_info' => 0,
...
<?php if ($_valid && !is_callable('content_5554b49ab1dfb5_38334863')) {function content_5554b49ab1dfb5_38334863($_smarty_tpl) {?><link href="<?php echo $_smarty_tpl->tpl_vars['_params']->value['site'];?>
...
/public/img/icons/ganado.png"/>
    ...
    <div class="pestanas_partido">
        ...
        <?php if (($_smarty_tpl->tpl_vars['match_info']->value->scorelocal<0)){?>
                <button type="button" class="btn-resta efect-hover" id="btn_add_local_contra" code-match="<?php echo $_smarty_tpl->tpl_vars['match_info']->value->codmatch;?>
" soy="local" score="<?php echo $_smarty_tpl->tpl_vars['match_info']->value->scorelocal;?>
" style="position: absolute;left: 0;  top: -38px;">
                    <span class="glyphicon glyphicon-plus"></span>&nbsp;
                    Sumar goles en contra
                </button>
                <button type="button" class="btn-resta efect-hover" id="btn_add_local_favor" code-match="<?php echo $_smarty_tpl->tpl_vars['match_info']->value->codmatch;?>
" soy="local" style="position: absolute;left: 0;">
                    <span class="glyphicon glyphicon-plus"></span>&nbsp;
                    Sumar goles a favor
                </button>
                <button type="button" class="btn-resta efect-hover restaurar_marcador" code-match="<?php echo $_smarty_tpl->tpl_vars['match_info']->value->codmatch;?>
" soy="local" style="position: absolute;left: 0;top: 38px;">
...
<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 pestana" id="_equipo_visitante">
    ...
    <?php if (($_smarty_tpl->tpl_vars['match_info']->value->scorevisitant<0)){?>
        <button type="button" class="btn-resta efect-hover" id="btn_add_visitant_contra" code-match="<?php echo $_smarty_tpl->tpl_vars['match_info']->value->codmatch;?>
" soy="visitante" score="<?php echo $_smarty_tpl->tpl_vars['match_info']->value->scorevisitant;?>
" style="position: absolute;right: 0;  top: -38px;">
            <span class="glyphicon glyphicon-plus"></span>&nbsp;
            Sumar goles en contra
        </button>
        <button type="button" class="btn-resta efect-hover" id="btn_add_visitant_favor" code-match="<?php echo $_smarty_tpl->tpl_vars['match_info']->value->codmatch;?>
" soy="visitante" style="position: absolute;right: 0;">
            <span class="glyphicon glyphicon-plus"></span>&nbsp;
            Sumar goles a favor
        </button>
        <button type="button" class="btn-resta efect-hover restaurar_marcador" code-match="<?php echo $_smarty_tpl->tpl_vars['match_info']->value->codmatch;?>
" soy="visitante" style="position: absolute;right: 0;top: 38px;">
            <span class="glyphicon glyphicon-repeat"></span>&nbsp;
            Restaurar marcador
        </button>
    <?php }?>
