<?php /* Smarty version Smarty-3.1.8, created on 2015-10-31 02:00:52
         compiled from "/var/www/toquela/views/terminos_condiciones/terminos_condiciones.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8720577125626ea8ecc0f91-83858144%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ff7e60eaf74f2572ed64d28b14dc3b470e74f47' => 
    array (
      0 => '/var/www/toquela/views/terminos_condiciones/terminos_condiciones.tpl',
      1 => 1446180634,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8720577125626ea8ecc0f91-83858144',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5626ea8ed03633_10211877',
  'variables' => 
  array (
    '_params' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5626ea8ed03633_10211877')) {function content_5626ea8ed03633_10211877($_smarty_tpl) {?><div class="terminos_condiciones">
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 init">
        <br>
        <h1 class="text-center text-gray-dark">TÉRMINOS Y CONDICIONES</h1>
        <p>
            <br>
        ...
        <br>
        <div class="archivos_adicionales">
            <h2 class="text-center text-gray-dark">ARCHIVOS ADICIONALES</h2>
            <br>
            <p><a href="<?php echo $_smarty_tpl->tpl_vars['_params']->value['site'];?>
/public/files/terminos_condiciones/terminos_y_condiciones.doc"><button type="button" class="btn btn_blue_light"><span class="glyphicon glyphicon-file"></span></button></a>&nbsp;&nbsp; Copia de términos y condiciones</p>
            <br>
            <p><a href="<?php echo $_smarty_tpl->tpl_vars['_params']->value['site'];?>
/public/files/terminos_condiciones/aviso_de_privacidad_formularios_escritos.doc"><button type="button" class="btn btn_blue_light"><span class="glyphicon glyphicon-file"></span></button></a>&nbsp;&nbsp; Aviso de privacidad</p>
            <br>
            <p><a href="<?php echo $_smarty_tpl->tpl_vars['_params']->value['site'];?>
/public/files/terminos_condiciones/formato_de_solicitudes_y_reclamaciones_sobre_el_tratamiento_de_datos_personales.doc"><button type="button" class="btn btn_blue_light"><span class="glyphicon glyphicon-file"></span></button></a>&nbsp;&nbsp; Formato de solicitudes y reclamaciones sobre el tratamiento de datos personales</p>
            <br>
            <p><a href="<?php echo $_smarty_tpl->tpl_vars['_params']->value['site'];?>
/public/files/terminos_condiciones/manual_de_politicas_y_procedimientos_para_la_proteccion_y_tratamiento_de_datos_personales_y_atencion_de_solicitudes.doc"><button type="button" class="btn btn_blue_light"><span class="glyphicon glyphicon-file"></span></button></a>&nbsp;&nbsp; Manual de políticas y procedimientos para la protección y tratamiento de datos personales y atención de solicitudes</p>
            <br>
        </div>
    </div>
</div><?php }} ?>