<?php /* Smarty version Smarty-3.1.8, created on 2015-05-14 10:11:09
         compiled from "C:\xampp\htdocs\toquela\views\equipos\sections\editarequipo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:126935554bb0d56daf5-61522588%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd362263214f16af81d66402af2929205d12d3bf3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\toquela\\views\\equipos\\sections\\editarequipo.tpl',
      1 => 1416600499,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '126935554bb0d56daf5-61522588',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5554bb0d7b1a25_82616305',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5554bb0d7b1a25_82616305')) {function content_5554bb0d7b1a25_82616305($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['iscreator']->value){?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding: 0px;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div style="border: 2px solid #ddd; padding: 15px;">
                            <div>
                                <p class="text-center" style="font-size: 20px;"><strong class="resalta">CAPITÁN: </strong><?php echo $_smarty_tpl->tpl_vars['captain']->value->name;?>
                ...
                <div id="mensaje-jugadores-excel" style="display: none;">
                    ...
                    <p class="text-center resalta" style="font-size: 22px;margin-bottom: 2%;">Información</p>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 registrado tipo" style="display: none">
                            <p class="title">Nuevos Usuarios en toquela</p>
                            <p class="desc"><span class="glyphicon glyphicon-record"></span>&nbsp;Aquí se muestran los usuarios registrados en el equipo y en toquela.</p>
                            <div class="content"></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 registrado-al-equipo tipo" style="display: none">
                        <p class="title">Usuarios agregados al equipo</p>
                            <p class="desc"><span class="glyphicon glyphicon-record"></span>&nbsp;Aquí se muestran los usuarios que se agreagregaron al equipo.</p>
                            <div class="content"></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ya-registrado tipo" style="display: none">
                            <p class="title">Usuarios ya registrados</p>
                            <p class="desc"><span class="glyphicon glyphicon-record"></span>&nbsp;Aquí se muestran los usuarios ya registrados en toquela, pero no en el equipo.</p>
                            <div class="content"></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ya-postulado tipo" style="display: none">
                            <p class="title">Usuarios ya postulados</p>
                            <p class="desc"><span class="glyphicon glyphicon-record"></span>&nbsp;Aquí se muestran los usuarios que ya estaban postulados al equipo anteriormente.</p>
                            <div class="content"></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 correo-mal tipo" style="display: none">
                            <p class="title">Revizar correos</p>
                            <p class="desc"><span class="glyphicon glyphicon-record"></span>&nbsp;Aquí se muestran los usuarios a inscribir que tienen mal escrito el correo.</p>
                            <div class="content"></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 campos-vacios tipo" style="display: none">
                            <p class="title">Datos incompletos</p>
                            <p class="desc"><span class="glyphicon glyphicon-record"></span>&nbsp;Aquí se muestran los usuarios a inscribir con datos deficientes.</p>
                            <div class="content"></div>
                        </div>
                    </div>
                </div>
