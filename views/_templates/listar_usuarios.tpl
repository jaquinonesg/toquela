        ...
        <div id="_jugadores_pagination" class="text-center">
            {foreach from=$jugadores item=jugador}
                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 container-jugador">
                    <a class="link" href="{$_params.site}/usuarios/index/usuario/{$jugador->coduser}" style="text-decoration: none;" target="blank">
        ...
        {if $init_js_paginator}
            <script type="text/javascript">
                $(document).ready(function() {
                   var paginajugadores = new PaginarJugadores("pagina_jugadores", "_jugadores_pagination", "_buscador_jugadores", "{$_params.site}/usuarios/index/paginajugadores");
                });
            </script>
        {/if}
    {else}
