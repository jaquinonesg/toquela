            ...
            <div class="panel panel-default {$class_inter}">
                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion{$acordion_parent}" href="#collapse_{$acordion_parent}{$count}">
                    <div class="panel-heading">
                        <h4 class="panel-title" title="Grupo {$match->round}">Grupo {$match->round}</h4>
                    </div>
                </a>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" title="Resultado parcial del partido">
                                        Resultados
                                        <br>
                                        <button class="btn btn-primary btn_result_parcial_resultados" round="{$match->round}" fase="{$match->group}" torneo="{$tournament->codtournament}" style="margin-top: 5px;" data-target="#modal-results-parcial">Tabla posicionesss</button>
                                    </th>
                                </tr>
                            </thead>
