            ...
            <div class="panel panel-default {$class_inter}">
                <div class="panel-heading">
                    <div class="btns-actions">
                        <button class="btn btn-primary btn_result_parcial_resultados" style="float: right; margin-right: 2px;" round="{$match->round}" fase="{$match->group}" torneo="{$tournament->codtournament}">Tabla posiciones</button>
                    </div>
