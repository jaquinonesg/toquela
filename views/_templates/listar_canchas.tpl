        ...
        <div id="_canchas_pagination" class="text-center">
            {foreach from=$complex item=canchas}
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 container-canchas"> 
                    <a class="link link-cancha" href="{$_params.site}/complejos/publico/{$canchas->codcomplex}" style="text-decoration: none;">
        ...
        {if $init_js_paginator}
            <script type="text/javascript">
                $(document).ready(function() {
                    var paginacanchasiframe = new PaginarCanchasIframe("pagina_canchas", "_canchas_pagination", "_buscador_canchas", "{$_params.site}/complejos/search_canchas");
                });
            </script>
