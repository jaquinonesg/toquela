                ...
                {foreach from=$games item=game}
                    {if $game->codcomplex}
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 container-equipo">
                            <a class="link" href="/toquela/partidos/deatalleDelPartido/{$game->codgames}" style="text-decoration: none;">
                                <div class="recuadro">
                                    ...
                                    <br>
                                    <p class="text-left" style="margin-left: 5px;"><span style="font-size: 16px;">Fecha y hora: </span>{$game->datetimegame}</p>
                                    <br>
                                </div>
                            </a>
                        </div>
    ...
    {if $verpaginator}
        <script type="text/javascript">
            $(document).ready(function() {
                var paginatorGames = new PaginatorGames('paginator_games', '_partidos_pagination', "_buscador_partido", '{$_params.site}/partidos/get_games');
            });
        </script>
    {/if}
{/if}