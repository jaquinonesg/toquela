...
<section id="disponibilidad">
    <div id="Cont-Mis-Canchas">
        ...
        <ul id="Menu-Int-Canchas">
            <li>
                <a href="{$_params.site}/complejos/info" display="informacion" class="selected">Información</a>
            </li>
            <li>
                <a href="{$_params.site}/complejos/disponibilidad/1" display="disponibilidad" {*<?php if($id_section == "2") echo 'class="selected"' ?>*}>Disponibilidad</a>
            </li>
        </ul>        
...
<div style="display:none">
    ...
    {if $_muestra_califica}
        {if $_califica}
            <form id="frm_califica" method="post" action="{$_params.site}/complejos/setCalificacion">
