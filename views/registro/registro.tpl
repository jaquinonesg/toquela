<div class="row index">
    ...
    <script type="text/javascript" src="{$_params.site}/views/index/jsmaps/maps.js"></script>
    <!-- scripts maps -->
    <link rel="stylesheet" href="http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css">
    <script src="{$_params.site}/public/js/vendor/jquery-ui.js"></script>
    <script type="text/javascript" src="{$_params.site}/views/index/jsmaps/controlmaps.js"></script>
    <!-- scripts maps -->
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 header-index">
        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 header-index-container">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <img class="img-responsive" style="margin: 0px auto;" src="{$_params.site}/public/img/Pelota_doble.png"/>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 contenido">
                <div class="text-verde-fluo" id="contend-miembros">
                    <span id="num-miembros">{$num_miembros}</span><br> miembros
                </div>
                ...
                {*<div class="btn btn_blue" style="width: 135px;" id="_btn_sobre_toquela">SOBRE TÓQUELA</div>
                <div class="btn btn_blue_light" style="width: 135px;" id="_btn_register">REGÍSTRESE</div>*}
                <form class="form-inline text-center" id="_form_registro_index" enctype="multipart/form-data" method="POST" action="{$_params.site}/modal/saveregister" role="form">
