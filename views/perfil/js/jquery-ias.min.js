...
(function(e) {
    ...
    Date.now = Date.now || function() {
        ...
        u()
    }, e.ias.defaults = {container: "#container", scrollContainer: e(window), item: ".item", pagination: "#pagination", next: ".next", noneleft: !1, loader: '<img src=""> ' , loaderDelay: 600, triggerPageThreshold: 6, trigger: "Cargar Mas Datos", thresholdMargin: !0, history: !0, onPageChange: function() {
        ...
        n(), this.setPage = function(e, t) {
            ...
            if (t) {
                ...
                e = window.location.hash.substring(0, 7) === "";
                if (e)
                    return r = parseInt(window.location.hash.replace("", ""), 10), {page: r};
            }
            return!1;
            ...
            var s;
            t ? history.pushState({ias: n}, r, i) : (s = n.page > 0 ? "/" + n.page : "", window.location.hash = s), e = !0;
