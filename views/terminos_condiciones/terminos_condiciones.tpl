<div class="terminos_condiciones">
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 init">
        ...
        <div class="archivos_adicionales">
            ...
            <br>
            <p><a href="{$_params.site}/public/files/terminos_condiciones/terminos_y_condiciones.doc"><button type="button" class="btn btn_blue_light"><span class="glyphicon glyphicon-file"></span></button></a>&nbsp;&nbsp; Copia de términos y condiciones</p>
            <br>
            <p><a href="{$_params.site}/public/files/terminos_condiciones/aviso_de_privacidad_formularios_escritos.doc"><button type="button" class="btn btn_blue_light"><span class="glyphicon glyphicon-file"></span></button></a>&nbsp;&nbsp; Aviso de privacidad</p>
            <br>
            <p><a href="{$_params.site}/public/files/terminos_condiciones/formato_de_solicitudes_y_reclamaciones_sobre_el_tratamiento_de_datos_personales.doc"><button type="button" class="btn btn_blue_light"><span class="glyphicon glyphicon-file"></span></button></a>&nbsp;&nbsp; Formato de solicitudes y reclamaciones sobre el tratamiento de datos personales</p>
            <br>
            <p><a href="{$_params.site}/public/files/terminos_condiciones/manual_de_politicas_y_procedimientos_para_la_proteccion_y_tratamiento_de_datos_personales_y_atencion_de_solicitudes.doc"><button type="button" class="btn btn_blue_light"><span class="glyphicon glyphicon-file"></span></button></a>&nbsp;&nbsp; Manual de políticas y procedimientos para la protección y tratamiento de datos personales y atención de solicitudes</p>
            <br>
        </div>
    </div>
</div>